...
public class AuditableExceptionLogger {
    ...
    @Before("@annotation(com.niam.common.annotation.Auditable)")
    public void beforeExecution() {
        startTime.set(System.currentTimeMillis());
    }

    @AfterThrowing(pointcut = "@annotation(com.niam.common.annotation.Auditable)", throwing = "ex")
