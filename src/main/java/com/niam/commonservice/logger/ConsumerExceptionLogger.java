...
@Profile("!logger-off")
public class ConsumerExceptionLogger {
    ...
    @AfterThrowing(pointcut = "@annotation(com.niam.commonservice.annotation.Auditable)", throwing = "ex")
    ...
    @Before("@annotation(com.niam.commonservice.annotation.Auditable)")
